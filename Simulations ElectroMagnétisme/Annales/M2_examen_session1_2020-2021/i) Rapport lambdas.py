...
# Variables pour mesure de lambda_milieu
M1 = 0
M2 = 0
cpt = 0
...
lambda_milieu_exp = (2 * np.pi * (c/n_milieu)) / ( (C1/dx) * C2*c)

print("\n\nLa longueur d'onde dans le milieu est : ", lambda_milieu_exp)
print("Le rapport des longueurs d'onde est : lambda_0/lambda_milieu = ", lambda_0/lambda_milieu_exp)
