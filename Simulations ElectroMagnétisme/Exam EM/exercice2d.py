...
isource = int(im/2)            #location of z-directed hard source
jsource = int(jm/2)          #location of z-directed hard source
...
#     Add cylinders
lambda_cylindre = lambda0/indice_cylindre

diam = ( 5*(lambda_cylindre)/2 ) / dx  # diameter of cylinder: lambda_cylindre/2
...
icenter2 = 2*ie/3 -2*ie/6  # i-coordinate of cylinder's center
